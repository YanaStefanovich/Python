"""Stepik_solutions 10.3 - Dict

Print the most frequent word in string s. If there's a tie, output the lexicographically smallest one. (shortened version of original task)
"""
